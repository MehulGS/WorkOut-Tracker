...
const AuthLayout = () => {
  ...
  return (
    <div
      className={`flex min-h-dvh relative transition-colors duration-300 overflow-hidden ${isDark
    ...
    >
      ...
      <button
        ...
        className={`absolute right-6 top-6 z-20 inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-xs font-medium tracking-wide shadow-sm backdrop-blur-sm transition-all duration-300 ${isDark
      ...
      >
        <span
          className={`h-2 w-2 rounded-full shadow-[0_0_10px_currentColor] ${isDark ? "bg-cyan-400" : "bg-amber-400"
            }`}
        />
      ...
      <div
        className={`w-1/2 hidden md:flex items-center justify-center overflow-hidden border-r-[8px] border-transparent bg-clip-border transition-all duration-500 ${isDark
      ...
      >
        <div
          className={`w-full h-full flex items-center justify-center transition-colors duration-500 ${isDark
      ...
      <div
        className={`w-full md:w-1/2 p-6 md:p-10 flex items-center justify-center transition-colors duration-500 ${isDark ? "bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950" : "bg-[#F4F7FE]"
          }`}
      >
        <div
          className={`w-full max-w-md rounded-3xl border shadow-xl backdrop-blur-sm transition-all duration-500 ${isDark
        ...
        >
          <div className="px-6 pt-6 pb-2 flex flex-col gap-1">
            ...
            <h1
              className={`text-2xl font-semibold tracking-tight ${isDark
